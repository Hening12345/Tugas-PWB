  ...
  <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <form method="post" action="/jurusan/{{ $editjrs->id }}">
              @method('patch')
              @csrf
  <div class="form-group">
    <label for="nama_jurusan">Nama Jurusan :</label>
    <input type="text" class="form-control @error('nama_jurusan') is-invalid @enderror" id="nama_jurusan" placeholder="Ubah Nama Jurusan" name="nama_jurusan" value="{{ $editjrs->nama_jurusan }}">
    @error ('nama_jurusan')
